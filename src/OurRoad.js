...
function OurRoad() {
  return (
    <div className="text-center mx-8 flex flex-col">
      <h2 className="text-7xl mb-6 font-script leading-10">Wspólna droga</h2>
      <p className="mb-4">
        Przyszedł więc czas na sakramentalne TAK.<br></br> Miesiące burzliwych
        przygotowań i dopinanie każdego szczegółu doprowadziły nas do dnia
        dzisiejszego, dziewiątej rocznicy naszego związku i jednocześnie
